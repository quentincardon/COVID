...
function getPage($db){
 ...
 $lesPages['actualiteeco']="actionActualiteEco";1;
 $lesPages['actualitejur']="actionActualiteJur";1;
 $lesPages['actualitemana']="actionActualiteMana";1;
 $lesPages['actualiteetu']="actionActualiteEtu";1;
 ######################################################################
 ...
 $lesPages['gestionContact']="actionGestionContact";1;
 $lesPages['mentions'] = "actionMentions";1;
